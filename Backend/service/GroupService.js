...
exports.deleteGroup = function(groupID) {
  // Dummy group data
  const groupData = {
    1: { name: "Group 1", maxMembers: 6, groupID: 1, members: 
      [
        { name: "Nancy Brown", id: 1 },
        { name: "Emma Weasly", id: 2 }
      ]
    },
    2: { name: "Group 2", maxMembers: 4, groupID: 2, members: 
      [
...
exports.enrollStudent = function(body) {
  // Dummy group data
  const groupData = {
    1: { name: "Group 1", maxMembers: 2, groupID: 1, members: 
      [
        { name: "Nancy Brown", id: 1 },
        { name: "Emma Weasly", id: 2 }
      ]
    },
    2: { name: "Group 2", maxMembers: 5, groupID: 2, members: 
      [
        { name: "James Stone", id: 3 },
        { name: "Sandy Rivers", id: 4 }
      ]
...
exports.unenrollStudent = function(body) {
  return new Promise(function(resolve, reject) {
    var examples = {};
    examples['application/json'] = { "maxMembers" : 6, "groupID" : 0, "members" : [ {"name" : "name", "id" : 1}, { "name" : "name", "id" : 1 } ],
  "name" : "name" };
    if (Object.keys(examples).length > 0) {
      resolve(examples[Object.keys(examples)[0]]);
    } else {
